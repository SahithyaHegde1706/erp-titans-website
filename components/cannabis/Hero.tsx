  ...
  return (
    <motion.section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto" initial="hidden" animate="visible" viewport={{ once: true }}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        {/* Left Side */}
        <div>
          <motion.div variants={badgeMotion} className="inline-flex items-center space-x-2 bg-green-100/50 rounded-full px-4 py-1.5 mb-6 border border-green-200/50">
            <Leaf className="w-4 h-4 text-[#16a34a]" />
            <span className="text-[#16a34a] text-xs font-bold tracking-wide">Compliance Excellence</span>
          </motion.div>
          ...
          <motion.p variants={subtitleMotion} className="text-lg text-[#64748b] leading-relaxed mb-10 max-w-[500px]">
            Specialized ERP recovery for cannabis producers struggling with regulatory compliance, seed-to-sale tracking, and inventory controls.
          </motion.p>
        ...
        <motion.div variants={cardMotion} className="relative pl-0 lg:pl-12 group">
          <div className="relative">
            ...
            <Image 
              src="/images/cannabis-hero.png" 
              alt="Cannabis Cultivation and Compliance Operations"
              width={800}
              height={600}
          ...
          <div className="absolute -bottom-6 right-4 sm:-bottom-8 sm:-right-4 bg-white rounded-[24px] p-5 shadow-[0_15px_40px_rgb(0,0,0,0.12)] flex items-center space-x-5 border border-slate-100 pr-8">
            <div className="w-12 h-12 bg-green-50 rounded-[12px] flex items-center justify-center border border-green-100/50">
              <ShieldCheck className="w-6 h-6 text-[#16a34a]" />
            </div>
            <div>
              <div className="text-2xl font-bold text-[#0f4c81]">100%</div>
              <div className="text-[11px] font-bold text-[#64748b] tracking-[0.1em] uppercase">Audit Ready</div>
            </div>
          </div>
        </motion.div>
      </div>
