...
function generateICS(selectedDate: string, selectedTime: string) {
...
export async function POST(request: Request) {
  try {
    ...
    const icsAttachmentBase64 = generateICS(selectedDate, selectedTime);
              ...
              <div style="background-color: #f8fafc; padding: 24px; border-radius: 8px; margin: 24px 0;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                  <tbody>
                    ...
                    <tr><td style="padding: 8px 0; color: #64748b;">Format:</td><td style="padding: 8px 0; font-weight: 500;">Virtual Meeting</td></tr>
